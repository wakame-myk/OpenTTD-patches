...
static const uint MAX_MAP_TILES_BITS = 30;                       ///< Maximal number of tiles in a map is equal to 2 ^ MAX_MAP_TILES_BITS.
...
static const uint MAX_MAP_TILES      = 1U << MAX_MAP_TILES_BITS; ///< Maximal number of tiles in a map = 1G (32k x 32k)
