...
static uint32_t GetTileLoopFeedback()
{
	...
	/* Maximal length LFSR feedback terms, from 12-bit (for 64x64 maps) to 31-bit.
	...
	static const uint32_t feedbacks[] = {
		...
		0x4004B2, 0x800B87, 0x10004F3, 0x200072D, 0x40006AE, 0x80009E3, 0x10000002, 0x20000029, 0x40000004,
	};
